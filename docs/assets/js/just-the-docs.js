...
jtd.getTheme = function() {
  ...
  var curr = GetFilename(cssFileHref)
  return curr;
...
jtd.setTheme = function(theme) {
  ...
  if(theme == 'dark-mode-preview'){
      var path = '{{ "assets/css/dark-mode-preview" | absolute_url }}' + '.css'
      cssFile.setAttribute('href', path);
  }
  else {
      var path = '{{ "assets/css/just-the-docs" | absolute_url }}' + '.css'
      cssFile.setAttribute('href', path);
  }
}
